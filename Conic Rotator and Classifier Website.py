...
app.layout = html.Div(style={'backgroundColor': colors['background'], "padding": "0", "margin": "0", "border": f"2px solid {colors['text2']}"}, children=[
    dcc.Tabs(id="AllTabsHolder", value="ConicHomeTab", children=[
        ...
        dcc.Tab(label="Conic Rotator Step-By-Step (Reccommended For Learning)", id="StepStepTab", value="StepStepTab", style={'font-weight': 'bold', 'backgroundColor':colors['backgroundNext'], 'color':colors['white']}, children=[
            ...
            html.Br(),
            html.Div(children=[
                dcc.Input(value="Enter Here (Delete these words)", type="text", style={'font-size': '125%', 'margin-left': '0.5%', "padding": "12px 20px", 'backgroundColor': colors['text'], 'color': 'black', 'width': '50%'}, id="inputEq2"),
                html.Br(),
                html.Br(),
                dcc.Dropdown(
                    id="optionsForChoose",
            ...
            html.Div(
                id="tabsContent",
                style={'backgroundColor': colors['backgroundNext'], 'color':colors['background'], 'font-size': '100%', 'padding': '5%', 'height':'auto', 'font-weight':'bold'}
            ),
            html.Br(),
            html.Br(),
            html.Div(
