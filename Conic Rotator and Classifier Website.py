...
app.layout = html.Div(style={'backgroundColor': colors['background'], "padding": "0", "margin": "0", "border": f"2px solid {colors['text2']}"}, children=[
    dcc.Tabs(id="AllTabsHolder", value="ConicHomeTab", children=[
        ...
        dcc.Tab(label="Conic Rotator Step-By-Step (Reccommended For Learning)", id="StepStepTab", value="StepStepTab", style={'font-weight': 'bold', 'backgroundColor':colors['backgroundNext'], 'color':colors['white']}, children=[
            ...
            html.Br(),
            html.Div(children=[
                dcc.Input(value="Enter Equation Here (= should be in equation)", type="text", style={'font-size': '125%', 'margin-left': '0.5%', "padding": "12px 20px", 'backgroundColor': colors['text'], 'color': 'black', 'width': '50%'}, id="inputEq2"),
                html.Br(),
                html.Br(),
                dcc.Dropdown(
                    id="optionsForChoose",
                ...
                html.Br(),
                html.P(
                    'Output will be displayed below on the light blue colored box (text in white).',
...
def update_steps(value):
    if value == 'D':
        ...
        return html.Div(children=[
            ...
            html.Div(
                f"Step 2.1, Find the Angle Of Rotation (Using the parts we figured out, you find the angle using this formula) ['Θ' is the angle] \u27AA {ConicRotatorLearn.Step2_FindTheAngleOfRotation_PartOne()}",
                id="Step2Part1",
                style={'backgroundColor': colors['background'], 'color':colors['white'], 'font-size': '150%', 'padding': '5%', 'height':'auto', 'font-weight':'bold'}
            ),
            html.Div(
